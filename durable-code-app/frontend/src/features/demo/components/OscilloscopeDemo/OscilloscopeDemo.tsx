/**
 * Purpose: Oscilloscope demonstration component
 * Scope: Complete oscilloscope demo feature
 * Overview: Real-time waveform visualization with WebSocket streaming
 * Dependencies: React, oscilloscope hook, child components
 * Exports: OscilloscopeDemo component
...
import styles from './OscilloscopeDemo.module.css';

function OscilloscopeDemoComponent(): ReactElement {
  const {
    state,
    stats,
    dataBuffer,
...
export const OscilloscopeDemo = React.memo(OscilloscopeDemoComponent);
